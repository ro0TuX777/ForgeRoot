...
def _query_cache(cache_path: Path, config: Dict[str, Any]) -> List[Dict[str, Any]]:
    conn = sqlite3.connect(str(cache_path))
    try:
        clauses = []
        params: List[Any] = []
        ...
        query = (
            ...
            "signature_count_required, signature_count_valid, approvers_json FROM evidence_runs "
