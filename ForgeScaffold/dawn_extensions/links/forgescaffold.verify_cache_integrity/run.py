        ...
        try:
            ...
            if not row:
                ...
                def _row_for(line_no: int) -> Optional[Dict[str, Any]]:
                    cur2 = conn.execute(
                        "SELECT line_no, timestamp, patchset_id, approval_id, risk_level, pipeline_name, verification_mode, status, review_packet_sha256, bundle_content_sha256, entry_hash, prev_entry_hash, signer_fingerprints_json, signature_count_required, signature_count_valid, approvers_json "
