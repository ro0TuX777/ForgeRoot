...
const NotesPanel: React.FC = () => {
  ...
  const [whiteCellDocuments, setWhiteCellDocuments] = useState<any[]>([]);
  ...
  const activeTabColor = useColorModeValue('blue.500', 'blue.200');
  ...
  const handleExport = () => {
    ...
    const filename = `${userData.username}${timestamp}.txt`;
  ...
  const handleWhiteCellDocumentSelect = (docName: string) => {
    ...
    loadDocumentContent(docName, 'white');
  };
      ...
      <Collapse in={isExpanded} animateOpacity>
        <Box p={4} flex="1">
          <Tabs variant="enclosed" flex="1" display="flex" flexDirection="column">
            <TabList>
              <Tab _selected={{ bg: activeTabBg, color: activeTabColor }}>Notes</Tab>
              <Tab _selected={{ bg: activeTabBg, color: activeTabColor }}>Documents</Tab>
            </TabList>

            <TabPanels flex="1">
              {/* Notes Tab */}
              <TabPanel h="full" p={4}>
                <VStack spacing={4} flex="1" h="full">
                  <Textarea
                    flex="1"
                    value={notes}
                    onChange={(e) => setNotes(e.target.value)}
                    placeholder="Enter your mission notes here..."
                    resize="none"
                    size="sm"
                    fontFamily="mono"
                            ...
                            <Text
                              ...
                              onClick={() => {
                                ...
                                if (userData.team) {
                                  ...
                                  loadDocumentContent(doc.name, userData.team);
                                }
                              }}
